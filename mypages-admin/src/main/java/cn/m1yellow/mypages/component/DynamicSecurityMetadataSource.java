...
import cn.m1yellow.mypages.config.IgnoreUrlsConfig;
...
public class DynamicSecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    @DubboReference(interfaceClass = SysRoleService.class, version = "1.0.0")
    private SysRoleService roleService;
    @DubboReference(interfaceClass = SysPermissionService.class, version = "1.0.0")
    private SysPermissionService permissionService;
    @DubboReference(interfaceClass = SysRolePermissionService.class, version = "1.0.0")
