package cn.m1yellow.mypages.excavation.config;
...
public class SwaggerConfig {
    ...
    public static final String SWAGGER_SCAN_BASE_PACKAGE = "cn.m1yellow.mypages.excavation.controller";
    ...
    public Docket docket(Environment environment) {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("mypages-excavation") // 分组名称
