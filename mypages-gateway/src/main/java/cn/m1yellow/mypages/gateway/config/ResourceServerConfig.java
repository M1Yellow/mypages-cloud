...
public class ResourceServerConfig {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        http.oauth2ResourceServer().jwt()
                ...
                // 自定义 jwt 认证管理器
                //.authenticationManager(newJwtAuthenticationManager());
    ...
    /*
    @Bean
    public ReactiveAuthenticationManager newJwtAuthenticationManager() {
        NimbusReactiveJwtDecoder nimbusReactiveJwtDecoder = new NimbusReactiveJwtDecoder(properties.getJwt().getJwkSetUri());
