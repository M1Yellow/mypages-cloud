...
public class SwaggerConfig {
    ...
    public static final String SWAGGER_SCAN_BASE_PACKAGE = "cn.m1yellow.mypages.god.controller";
    public static final String VERSION = "0.0.1";

    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("MyPages API")
                .description("Swagger mypages-god API 接口信息。")
                .license("Apache2.0")
